<%@ Page Title="Seguimiento del progreso - EduWeb" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SeguimientoProgreso.aspx.cs" Inherits="SistemaEduWeb.SeguimientoProgreso" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <main class="p-1">
        <div class="card">
            <h5 class="card-header"><i class="fas fa-tasks"></i> Seguimiento del progreso</h5>
            <div class="card-body">
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <div class="row">
                            <div class="col-12">
                                <p>En esta sección podra ver su progreso individual en las distintas áreas, así como ver sus recomendaciones dadas por los docentes.</p>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-12">
